                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="absolute right-0 mt-2 w-64 glass-card p-3 rounded-2xl z-50 border border-primary/20 shadow-2xl shadow-primary/30 backdrop-blur-xl bg-gradient-to-br from-white/10 to-white/5"
                        >
